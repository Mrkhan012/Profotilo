...
// Github Link
const String twitter = 'https://x.com/MR__KHAN012?t=rHBtO9GZ_UCwQPYjZULrXQ&s=35';
// Github Link
const String youtube =
    'https://www.youtube.com/channel/UCXooUY2oL_eqGhTaZn-ExSg';
// Github Link
const String linkedin = 'https://www.linkedin.com/in/afarojkha-pathan-3617b3223/';
// Github Link
const String buymeacoffee = 'https://www.buymeacoffee.com/sudeshnb';
// Github Link
const String instagram = 'https://instagram.com/mr__khan0191?igshid=NzZlODBkYWE4Ng==';
// socialLinks
...
//
// Github Link
const String fiverr = 'https://www.fiverr.com/mrkhan3371?up_rollout=true';
// Github Link
const String upwork = 'https://www.upwork.com/freelancers/~015c46144016569e31';
// Github Link
const String whatsapp = 'https://api.whatsapp.com/send?phone=9156291160';
